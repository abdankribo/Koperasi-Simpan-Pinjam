...
<nav class="navbar navbar-expand-lg navbar-dark position-fixed w-100" style="background-color: #009D9D; ">
        ...
        <a class="navbar-brand" href="./edit_anggota.php">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) == 'edit_anggota.php') echo 'active'; ?> mx-1" href="./edit_anggota.php">Anggota</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) == 'tambah_materi.php') echo 'active'; ?> mx-1" href="./tambah_materi.php">Dokumen</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) == 'pinjaman.php') echo 'active'; ?> mx-1" href="./pinjaman.php">Pinjaman</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) == 'simpanan.php') echo 'active'; ?> mx-1" href="./simpanan.php">Simpanan</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) == 'pihak3.php') echo 'active'; ?> mx-1" href="./pihak3.php">Master Admin</a>
                </li>
                <?php
                ...
                if(isset($_SESSION['IsAdmin'])) {
                    ...
                    <li class="nav-item dropdown"  onmouseover="showDropdown()" onmouseout="hideDropdown()">
                        <a class="nav-link dropdown-toggle <?php if (basename($_SERVER['PHP_SELF']) == 'set_web.php') echo 'active'; ?> mx-1" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Admin
                        </a>
                        
                        <ul class="dropdown-menu" id="myDropdown" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#form_edit"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-key" viewBox="0 0 16 16">
                            <path d="M0 8a4 4 0 0 1 7.465-2H14a.5.5 0 0 1 .354.146l1.5 1.5a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0L13 9.207l-.646.647a.5.5 0 0 1-.708 0L11 9.207l-.646.647a.5.5 0 0 1-.708 0L9 9.207l-.646.647A.5.5 0 0 1 8 10h-.535A4 4 0 0 1 0 8m4-3a3 3 0 1 0 2.712 4.285A.5.5 0 0 1 7.163 9h.63l.853-.854a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.793-.793-1-1h-6.63a.5.5 0 0 1-.451-.285A3 3 0 0 0 4 5"/>
                            <path d="M4 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
                            </svg> Ganti Password</a></li>
                            <li><a class="dropdown-item" href="./set_web.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
...
<?php
    ...
    $admin = select("SELECT * FROM admin WHERE username_admin = '$id_admin'"); 
    foreach ($admin as $adminku):
...
<div class="modal-dialog">
    <div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ganti Password Akun <?= $adminku['password_admin']; ?></h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <form action="../admin/change_pass.php" method="post" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="tpassword" class="form-control" value="<?= $adminku['password_admin']; ?>">
