        ...
        <div class="container">
            <div class="row h-100">
                ...
                <div>
                    ...
                    <h2 style="font-family: Poppins;"><b>DAFTAR SIMPANAN ANGGOTA</b></h2>
                    ...
                    ?>
                        <div class="container">
                            <div class="row">
                                ...
                                <form action="pihak3_simpanan.php" method="post">
                        ...
                        <?php
                            ...
                            <tbody style="background-color: #009D9D;">
                                <?php 
                             $id_smp = 1;
                             $data = mysqli_query($db, "SELECT * FROM simpanan WHERE nomor_anggota IN (SELECT nomor_anggota FROM anggota WHERE status_anggota = 'Aktif' AND unit IN (SELECT unit FROM master_admin WHERE id_master = $id_master))");
                             $jum_total = 0;
                            ...
                            <tbody style="background-color: #009D9D;"> 
                             <?php
                            $id_smp = 1;
                            $query = "SELECT * FROM simpanan_record WHERE bulan = $bulan";
                            $data = mysqli_query($db, $query);
                            $jum_total = 0;
                            
                            while($d = mysqli_fetch_array($data)) {
                                $query2 = "SELECT * FROM anggota WHERE nomor_anggota = '{$d['id_anggota']}' AND status_anggota = 'Aktif' AND unit IN (SELECT unit FROM master_admin WHERE id_master = $id_master)";
    ...
    <div class="modal-dialog">
        ...
        <form action="simpanan.php" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="tpokok" class="form-control" value="<?= $d['spokok']; ?>">
                    <label for="floatingInputTanggal">Pokok</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="twajib" class="form-control" value="<?= $d['swajib']; ?>">
                    <label for="floatingInputTanggal">Wajib</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="tsukarela" class="form-control" value="<?= $d['ssukarela']; ?>">
                    <label for="floatingInputTanggal">Sukarela</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="thariraya" class="form-control" value="<?= $d['shariraya']; ?>">
                    <label for="floatingInputTanggal">Hari raya</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="tkhusus" class="form-control" value="<?= $d['skhusus']; ?>">
...
<div class="modal-dialog">
    ...
    <form action="simpanan.php" method="post" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="tpokok" class="form-control" value="0">
                <label for="floatingInputPelatihan">Simpanan Pokok</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="twajib" class="form-control" value="0">
                <label for="floatingInputPelatihan">Simpanan Wajib</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="tsukarela" class="form-control" value="0">
                <label for="floatingInputTanggal">Simpanan  Sukarela</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="thariraya" class="form-control" value="0">
                <label for="floatingInputTanggal">Simpanan Hari raya</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="tkhusus" class="form-control" value="0">
