    ...
    <section id="hero">
        <div class="container h-100">
            <div class="row h-100">
                ...
                <div>
                    <h2 style="font-family: Poppins;"><b>DAFTAR PINJAMAN ANGGOTA</b></h2>

                        <div class="container">
                            <div class="row">
                                <div class="col-md-2 text-start" style="font-family: Poppins;">
                                <form action="pihak3_pinjaman.php" method="post">
                        ...
                        <?php
                            ...
                            <tbody style="background-color: #009D9D;">
                                <?php 
                             $id_smp = 1;
                             $data = mysqli_query($db, "SELECT * FROM pinjaman WHERE nomor_anggota IN (SELECT nomor_anggota FROM anggota WHERE status_anggota = 'Aktif' AND unit IN (SELECT unit FROM master_admin WHERE id_master = $id_master))");
                             $jum_total = 0;
    ...
    <div class="modal-dialog">
        ...
        <form action="pinjaman.php" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="ppokok" class="form-control" value="<?= $d['pinjaman_pokok']; ?>">
                    <label for="floatingInputPelatihan">Pinjaman Pokok</label>
                </div>                                                                                                                         
                <div class="form-floating mb-3">
                    <input type="text" name="pjasa" class="form-control" value="<?= $d['pinjaman_jasa']; ?>">
                    <label for="floatingInputTanggal">Pinjaman Jasa</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="apokok" class="form-control" value="<?= $d['angsuran_pokok']; ?>">
                    <label for="floatingInputTanggal">Angsuran Pokok</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="ajasa" class="form-control" value="<?= $d['angsuran_jasa']; ?>">
...
<div class="modal-dialog">
    ...
    <form action="pinjaman.php" method="post" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="ppokok" class="form-control" value="0">
                <label for="floatingInputPelatihan">Pinjaman Pokok</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="pjasa" class="form-control" value="0">
                <label for="floatingInputPelatihan">Pinjaman Jasa</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="apokok" class="form-control" value="0">
                <label for="floatingInputTanggal">Angsuran  Pokok</label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="ajasa" class="form-control" value="0">
                <label for="floatingInputTanggal">Angsuran Jasa</label>
            </div>
            <!-- <div class="form-floating mb-3">
