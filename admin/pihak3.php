...
$data_anggota = select("SELECT * FROM master_admin");
...
?>
    ...
    <section id="hero">
        <div class="container">
            <div class="row h-100">
                <h2 style="font-family: Poppins;"><b><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
  <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
</svg>Akun Master Admin</b></h2>

                    <div class="container">
                        <div class="row">
                            <div class="col mb-3 me-2 text-end">
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#form_tambah" style="font-family: Poppins;">
                                Tambah
                                <!-- </button>
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#form_upload" style="font-family: Poppins;">
                                Upload File Excel
                                </button> -->
                            </div>  
                        </div>
                        ...
                        <thead style="background-color: #007070;">
                            <tr>    
                                ...
                                <th class="text-start text-light">Username</th>
                                <th class="text-start text-light">Password</th>
                                <!--<th class="text-start text-light">NamaKoperasi</th>-->
                                
                                <!-- <th class="text-start text-light">Jabatan</th> -->
                                <th class="text-start text-light">Kelompok</th>
                        ...
                        <tbody style="background-color: #009D9D;">
                            ...
                            <tr>
                                ...
                                <td class="text-start text-light"><?= $anggota['username_master']; ?></td>
                                <td class="text-start text-light"><?= $anggota['password_master']; ?></td>                               
                                
                                <td class="text-start text-light"><?= $anggota['unit']; ?></td>
                                
                                <td class="text-center text-light"><span class="xedit" data-bs-toggle="modal"  data-bs-target="#form_tambah<?php echo $anggota['id_master'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                                </svg></span></td>
                                <td class="text-center text-light"><span class="xdelete" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $anggota['id_master'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
...
include 'edit_master.php'
    ...
    ?>
        <!-- Modal Edit -->
    <div class="modal fade" id="form_tambah<?php echo $anggota['id_master'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Data Akun <?= $anggota['username_master']; ?></h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="pihak3.php" method="post" enctype="multipart/form-data">
            <input type="hidden" name="tmaster" value="<?= $anggota['id_master']; ?>">
            <div class="modal-body">
                
                <div class="form-floating mb-3">
                    <input type="text" name="tusername" class="form-control" value="<?= $anggota['username_master']; ?>">
                    <label for="floatingInputPelatihan">Username</label>
                </div> 
                <div class="form-floating mb-3">
                    <input type="text" name="tpassword" class="form-control" value="<?= $anggota['password_master']; ?>">
                    <label for="floatingInputPelatihan">Password</label>
                </div> 
                <div class="form-floating mb-3">
                ...
                <!-- <div class="form-floating mb-3">
                    <input type="text" name="tusername" class="form-control" value="<?= $anggota['username_user']; ?>">
                    <label for="floatingInputPelatihan">Username</label>
                </div> -->
...
<!-- Modal Delete -->
<div class="modal fade" id="staticBackdrop<?php echo $anggota['id_master'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        Yakin ingin menghapus data <b><?= $anggota['username_master']; ?> ?</b>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
        <button type="button" class="btn btn-danger"><a class="link-up4" href="hapus_master.php?datae=<?php echo $anggota['id_master'] ?>">Hapus</a></button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal-dialog">
    <div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tambah Akun Master Admin</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <form class="needs-validation" action="pihak3.php" method="post" enctype="multipart/form-data" novalidate>
        <div class="modal-body">
            <div class="form-floating mb-3">
                <input type="text" name="tusername" class="form-control" required>
                <label for="floatingInputPelatihan">Username</label>
            ...
            <div class="form-floating mb-3">
                <input type="text" name="tpassword" class="form-control" required>
                <label for="floatingInputPelatihan">Password</label>
                <div class="invalid-feedback">
                    Wajib di isi!
                </div>
            ...
            <div class="form-floating mb-3">
                <input type="text" name="tkelompok" class="form-control" required>
                <label for="floatingInputPelatihan">Kelompok</label>
                <div class="invalid-feedback">
                    Wajib di isi!
                </div>
            ...
            <!-- <div class="form-floating mb-3">
                <input type="text" name="tusernama" class="form-control" required>
                <label for="floatingInputPelatihan">Username</label>
                <div class="invalid-feedback">
                    Wajib di isi!
                </div>
            ...
            <div class="form-floating mb-3">
                <input type="date" name="tlahir" class="form-control" value="<?php echo date('Y-m-d'); ?>">
