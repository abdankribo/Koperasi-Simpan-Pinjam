    ...
    <div class="modal-dialog">
        ...
        <form action="edit_anggota.php" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="tpassword" class="form-control" value="<?= $anggota['password_user']; ?>">
                    <label for="floatingInputPelatihan">Password</label>
                </div> 
                <div class="form-floating mb-3">
                    <input type="text" name="tkelompok" class="form-control" value="<?= $anggota['unit']; ?>">
                    <label for="floatingInputPelatihan">Keterangan</label>
                </div> 
                <div class="form-floating mb-3">
                ...
                <div class="form-floating mb-3">
                    <input type="text" name="ttelp" class="form-control" value="<?= $anggota['nomor_telepon']; ?>" pattern="[0-9]{12}" title="Harap masukkan 12 digit angka">
                    <label for="floatingInputTanggal">No. Telp</label>
                    <div class="invalid-feedback">
                    Harap masukkan 12 digit angka
                    </div>
                </div>
                <div class="form-floating mb-3">
...
<div class="modal-dialog">
    ...
    <form class="needs-validation" action="edit_anggota.php" method="post" enctype="multipart/form-data" novalidate>
        <div class="modal-body">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="ttelp" class="form-control" pattern="[0-9]{12}">
                <label for="floatingInputTanggal">No. Telp</label>
                <div class="invalid-feedback">
                Harap masukkan 12 digit angka
                </div>
