                    ...
                    <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 6 6 0 0 1 3.13-1.567"/>
                        ...
                        <!-- <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-2 text-start" style="font-family: Poppins;">
                                <form action="neraca.php" method="post">
                        ...
                        <?php
                            ...
                            <tr align="center">
                                ...
                                <th class="text-center text-light">Aset</th>
                            ...
                            $simpanan_w_old = '';
                                    ...
                                    <tr>
                                        <th style="color: white; text-align: left;">
                                            <h5><b>Aset Lancar :</b></h5>
                                        </th>
                                        <th style="color: white; text-align: left; border:none;"></th>
                                        <th style="color: white; text-align: left; border:none;"></th>
                                    </tr>
                                    <tr>
                                        <th style="color: white; text-align: left; border-bottom: 1px solid #009D9D; border-right: none">Kas</th>
                                        <td style="color: white; text-align: right; ">0</td>
                                        <td style="color: white; text-align: right; border: none;">0</td>
                                    </tr>
                                    <tr>
                                        <th style="color: white; text-align: left;  border-bottom: 1px solid #009D9D; border-right: none">Bank</th>
                                        <td style="color: white; text-align: right; ">0</td>
                                        <td style="color: white; text-align: right;  border: none">0</td>
                                    </tr>
                                    <tr>
                                        <th style="color: white; text-align: left; border-bottom: 1px solid #009D9D; border-right: none">Piutang Simpan Pinjam</th>
                                        <td style="color: white; text-align: right;"><?php echo number_format($piutang_sp, 0, ',', '.'); ?> </td>
                                        <td style="color: white; text-align: right; border: none;"><?php echo number_format($piutang_sp_old, 0, ',', '.'); ?></td>
                                    </tr>
                                    <tr>
                                        <th style="color: white; text-align: left; border: none">Piutang Khusus</th>
                                        <td style="color: white; text-align: right;"><?php echo number_format($piutang_k, 0, ',', '.'); ?> </td>
                                        <td style="color: white; text-align: right; border: none;"><?php echo number_format($piutang_k_old, 0, ',', '.'); ?></td>
                                    </tr>
                                    <tr>
                                        <th style="color: white; text-align: center;border:none;">
                                            Jumlah
                                        </th>
                                        <td style="color: white; text-align: right;">
                                            <?php echo number_format($piutang_sp + $piutang_k, 0, ',', '.'); ?>
                                        </td>
                                        <td style="color: white; text-align: right; border: none;">
                                            <?php echo number_format($piutang_sp_old + $piutang_k_old, 0, ',', '.'); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="color: white; text-align: left; border: none;">
                                            <h5><b>Aset Tetap :</b></h5>
                                        </th>
                                        <td style="border: none;"></td>
                                        <td style="border: none;"></td>
                                    </tr>
                                    <tr>
                                        <th style="color: white; text-align: left; border-bottom: 1px solid #009D9D; border-right: none">Inventaris</th>
                                        <td style="color: white; text-align: right; ">0</td>
                                        <td style="color: white; text-align: right; border: none;">0</td>
                                    </tr>
                                    <tr>
                                        <th style="color: white; text-align: left; border: none;">Ak. Penyusustan Inventaris</th>
                                        <td style="color: white; text-align: right; ">0</td>
                                        <td style="color: white; text-align: right; border: none;">0</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-start text-light" style="border:none">
                                            <h5><b>Kewajiban Jangka Pendek:</b></h5>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end text-light">
                                            <?php echo number_format($simpanan_s, 0, ',', '.'); ?>
                                        </td>
                                        <td class="text-end text-light">
                                            <?php echo number_format($simpanan_s_old, 0, ',', '.'); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        
                                        <th class="text-start text-light" style="border-bottom: 1px solid #009D9D; border-right: none">
                                            Penyisihan Sewa Gedung
                                        </th>
                                        <td class="text-end text-light">
                                            0
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end text-light">
                                            <?php echo number_format($simpanan_p, 0, ',', '.'); ?>
                                        </td>
                                        <td class="text-end text-light">
                                            <?php echo number_format($simpanan_p_old, 0, ',', '.'); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-end text-light">
                                            <?php echo number_format($simpanan_w, 0, ',', '.'); ?>
                                        </td>
                                        <td class="text-end text-light">
                                            <?php echo number_format($simpanan_w_old, 0, ',', '.'); ?>
                                        </td>
                                    </tr>
                                    <tr>
